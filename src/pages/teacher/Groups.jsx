  ...
  return (
    <div className="space-y-7">
      <SectionHeading title={t("pages.teacher.groups.title")} subtitle={t("pages.teacher.groups.subtitle")}
        action={<button className="btn-primary text-sm"><Plus className="h-4 w-4" /> {t("pages.teacher.groups.newGroup")}</button>} />

      <div className="grid grid-cols-3 gap-4">
        <Panel className="!p-4" delay={0}>
          <div className="flex items-center gap-3">
            <IconTile icon={FolderKanban} accent="primary" />
            <div><div className="text-xl font-semibold text-white">{teacherGroups.length}</div><div className="text-xs text-white/40">{t("pages.teacher.groups.groups")}</div></div>
          </div>
        </Panel>
        ...
        <Panel className="!p-4" delay={0.1}>
          <div className="flex items-center gap-3">
            ...
            <div><div className="text-xl font-semibold text-white">6.5</div><div className="text-xs text-white/40">{t("pages.teacher.groups.avgBand")}</div></div>
          </div>
        </Panel>
      </div>
