        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full glass px-4 py-1.5 text-sm text-white/70">
              <LayoutDashboard className="h-3.5 w-3.5 text-secondary-400" /> The platform
            </span>
            <h2 className="mt-6 font-display text-4xl md:text-5xl font-semibold tracking-tight text-white text-balance">
              A dashboard for <span className="gradient-text">every role</span>
            </h2>
            <p className="mt-4 text-lg text-white/55">
              Students learn, teachers review, managers monitor and admins control —
              each with a workspace designed around what they actually do.
            </p>

            <div className="mt-8 space-y-4">
              {[
                { icon: FileCheck2, title: "Instant AI grading", desc: "Essays pre-graded before a teacher even opens them." },
                { icon: Activity, title: "Live analytics", desc: "Band trends, attendance and performance in real time." },
                { icon: Trophy, title: "Gamified learning", desc: "Streaks, badges and a class leaderboard that motivates." },
              ].map((item, i) => (
                <motion.div
                  key={item.title}
              ...
              <div className="rounded-2xl bg-bg-soft overflow-hidden">
                ...
                <div className="p-5 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm font-semibold text-white">Welcome back, Aziza</div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-xl glass p-4">
                      <div className="text-[10px] text-white/40">Latest essay</div>
                      <div className="mt-2 text-3xl font-semibold text-emerald-400">6.5</div>
                      <div className="mt-1 text-[10px] text-white/40">Band score</div>
                    </div>
                    <div className="rounded-xl glass p-4">
                      <div className="text-[10px] text-white/40 mb-2">Skills</div>
                  ...
                  <div className="rounded-xl glass p-4">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-[11px] text-white/50">Weekly activity</span>
